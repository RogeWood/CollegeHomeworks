...
//               c:/Users/user/Desktop/Work/CO_homework/LAB5-2/homework/vivado/zynq_system/zynq_system.gen/sources_1/bd/zynq/ip/zynq_axi_ahblite_bridge_0_0/zynq_axi_ahblite_bridge_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "zynq_axi_ahblite_bridge_0_0,axi_ahblite_bridge,{}" *) (* core_generation_info = "zynq_axi_ahblite_bridge_0_0,axi_ahblite_bridge,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_ahblite_bridge,x_ipVersion=3.0,x_ipCoreRevision=30,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_INSTANCE=zynq_axi_ahblite_bridge_0_0,C_S_AXI_ADDR_WIDTH=32,C_S_AXI_DATA_WIDTH=32,C_S_AXI_SUPPORTS_NARROW_BURST=0,C_S_AXI_ID_WIDTH=12,C_M_AHB_ADDR_WIDTH=32,C_M_AHB_DATA_WIDTH=32,C_DPHASE_TIMEOUT=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_ahblite_bridge,Vivado 2024.2" *) 
module zynq_axi_ahblite_bridge_0_0(s_axi_aclk, s_axi_aresetn, s_axi_awid, 
